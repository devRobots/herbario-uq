...
public class TestTaller10 {
	...
	/**
	 * 1. Prueba que permite contar determinar el n�mero de familias que se han registrado
	 */
	@Test
	...
	/**
	 * 2. Test que permita contar el n�mero de personas a 
	 * las que le han aceptado un registro (envio) por d�a
	 */
	@Test
	@Transactional(value = TransactionMode.ROLLBACK)
	 ...
	 * que m�s especies tiene registradas. 
	 */
	@Test
	@Transactional(value = TransactionMode.ROLLBACK)
